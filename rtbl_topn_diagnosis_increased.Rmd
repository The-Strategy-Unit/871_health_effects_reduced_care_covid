...
react_tbl_div_h2(tbl, selector = "rtbl-topn-ed", h2title = "ED diagnoses with the biggest increases", title = "When activity returned to pre-pandemic levels in the second-half of 2022 these diagnoses were recorded with greater frequency than in 2019")
```
...
react_tbl_div_h2(tbl, selector = "rtbl-topn-ip", h2title = "Inpatient diagnoses with the biggest increases", title = "When activity returned to pre-pandemic levels in the second-half of 2022 these diagnoses were recorded with greater frequency than in 2019")
```
