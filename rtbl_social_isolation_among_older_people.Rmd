...
react_tbl_div(tbl, selector = "rtbl-grp-ed", title = "ED diagnoses for effects of social isolation among older people")
```

```{r, react-tbl-ip, echo=FALSE}
tbl <- build_react_tbl(ip_dat, units = "Admis.", colwidth = c(240, 200, 200))

react_tbl_div(tbl, selector = "rtbl-grp-ip", title = "Inpatient diagnoses for effects of social isolation among older people")
```
