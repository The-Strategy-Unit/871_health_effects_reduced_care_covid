...
react_tbl_div(tbl, selector = "rtbl-grp-ed", title = "Table 10: ED diagnoses of eating disorders")
```

```{r, react-tbl-ip, echo=FALSE}
tbl <- build_react_tbl(ip_dat, units = "Admis.", colwidth = c(240, 200, 200))

react_tbl_div(tbl, selector = "rtbl-grp-ip", title = "Table 11: Inpatient diagnoses of eating disorders")
```
