...
theme_871 <- function(base_size = 10, base_family = "Work Sans") {
  ...
  theme(
    ...
    # axes
    , axis.line =          element_line(size = .2, color = "#d3d3d3")
    ...
    , strip.text =            element_text(colour = "#686f73", size = base_size, hjust = 0, vjust = .5, margin = margin(t = half_line * .5, b = half_line * .5, l = half_line * .5))
