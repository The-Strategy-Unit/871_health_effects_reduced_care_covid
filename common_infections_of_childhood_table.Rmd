...
div(
  class = "childhood-infections-ip-rtbl",
  div(
    class = "rtbl-title",
    "Inpatient diagnoses for common infections of childhood"
  ),
...
div(
  class = "childhood-infections-ed-rtbl",
  div(
    class = "rtbl-title",
    "ED diagnoses for common infections of childhood"
  ),
  htmlwidgets::appendContent(
    tbl,
    htmltools::tags$span(
